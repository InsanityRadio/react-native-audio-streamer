...
@objc open class FRadioPlayer: NSObject {
     ...
     */
    @objc open weak var delegate: FRadioPlayerDelegate?
    ...
    @objc open func setRadioURL (with radioURL: URL) {
    ...
    @objc open private(set) dynamic var state = FRadioPlayerState.urlNotSet {
        didSet {
    ...
    @objc open private(set) dynamic var playbackState = FRadioPlaybackState.stopped {
        didSet {
